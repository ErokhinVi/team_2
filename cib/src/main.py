...
async def index() -> str:
    ...
    return (
        ...
        ".brand{font-weight:800;font-size:16px;letter-spacing:.5px;color:#111}"
        ".hero h1{font-size:35px;font-weight:800;margin:14px 0 8px;max-width:620px}"
        ".hero p{font-size:18px;color:#3a3a26;max-width:560px}"
        ".stats{display:flex;gap:28px;flex-wrap:wrap;margin-top:24px}"
        ".stat b{display:block;font-size:25px;font-weight:800}"
        ".stat span{font-size:14px;color:#4a4a30}"
        ".main{max-width:1040px;margin:-24px auto 56px;padding:0 24px}"
        "section{margin-top:36px}"
        "h2{font-size:21px;font-weight:700;display:flex;align-items:center;gap:10px;margin-bottom:14px}"
        ".ic{font-size:23px}"
        ".count{font-size:13px;font-weight:700;background:#111;color:#ffed00;"
        ...
        ".hl{display:inline-block;font-size:14px;font-weight:700;color:#111;"
        "background:#ffed00;border-radius:8px;padding:3px 9px;margin-bottom:10px}"
        ".card h3{font-size:17px;font-weight:700}"
        ".card .ru{font-size:13px;color:#999;margin:2px 0 8px}"
        ".card p{font-size:14px;color:#555}"
        "footer{max-width:1040px;margin:0 auto 40px;padding:0 24px;font-size:13px;color:#aaa}"
        "</style></head><body>"
