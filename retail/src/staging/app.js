  (function(){
    ...
    // STAGING ONLY — grouped bottom nav. Bottom shows 5 groups; a sub-tab
    // strip appears for groups with >1 pane.
    const TAB_GROUPS = [
    ...
    // showGroup("home") fires from the IIFE tail to avoid TDZ on later `let`s.
    ...
    loadProducts();
    applyLang();
    // All `let` state is initialized — safe to fire the initial nav activation.
    showGroup("home");
  })();
