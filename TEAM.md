...
|---|---|---|
| retail | `http://localhost:8001` | `https://raif-offsite-b-retail.onrender.com` |
| cib | `http://localhost:8002` | `https://raif-offsite-b-cib.onrender.com` |
| backend | `http://localhost:8003` | `https://raif-offsite-b-backend.onrender.com` |
